...
public class MsImagingProjectClient {
    ...
    public MsImagingProjectClient(RestClient client, Environment env) {
    ...
    public List<PatientPayload> getPatientByIds(Set<Long> patientIds) {
        log.debug("Fetching endpointId of endpointName: {}", endpointName);
