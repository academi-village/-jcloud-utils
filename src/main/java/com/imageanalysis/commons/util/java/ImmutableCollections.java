...
class ImmutableCollections {
    ...
    static abstract class AbstractImmutableList<E> extends AbstractImmutableCollection<E>
        ...
        public int indexOf(Object o) {
            com.imageanalysis.commons.util.java.Objects.requireNonNull(o);
            for (int i = 0, s = size(); i < s; i++) {
                if (o.equals(get(i))) {
                    return i;
                }
    ...
    static final class SubList<E> extends AbstractImmutableList<E>
        ...
        public E get(int index) {
            com.imageanalysis.commons.util.java.Objects.checkIndex(index, size);
    ...
    static final class List12<E> extends AbstractImmutableList<E>
        ...
        List12(E e0) {
            this.e0 = com.imageanalysis.commons.util.java.Objects.requireNonNull(e0);
            this.e1 = null;
        }

        List12(E e0, E e1) {
            this.e0 = com.imageanalysis.commons.util.java.Objects.requireNonNull(e0);
            this.e1 = com.imageanalysis.commons.util.java.Objects.requireNonNull(e1);
        }
    ...
    static final class ListN<E> extends AbstractImmutableList<E>
        ...
        ListN(E... input) {
            ...
            for (int i = 0; i < input.length; i++) {
                tmp[i] = com.imageanalysis.commons.util.java.Objects.requireNonNull(input[i]);
            }
            elements = tmp;
        }
    ...
    static final class Set12<E> extends AbstractImmutableSet<E>
        ...
        Set12(E e0, E e1) {
            if (e0.equals(com.imageanalysis.commons.util.java.Objects.requireNonNull(e1))) { // implicit nullcheck of e0
    ...
    static final class Map1<K, V> extends AbstractImmutableMap<K, V> {
        ...
        Map1(K k0, V v0) {
            this.k0 = com.imageanalysis.commons.util.java.Objects.requireNonNull(k0);
            this.v0 = com.imageanalysis.commons.util.java.Objects.requireNonNull(v0);
        }

        @Override
        public Set<Map.Entry<K, V>> entrySet() {
            return Sets.of(new KeyValueHolder<>(k0, v0));
        }
    ...
    static final class MapN<K, V> extends AbstractImmutableMap<K, V> {
        ...
        MapN(Object... input) {
            ...
            for (int i = 0; i < input.length; i += 2) {
                @SuppressWarnings("unchecked")
                K k = com.imageanalysis.commons.util.java.Objects.requireNonNull((K) input[i]);
                @SuppressWarnings("unchecked")
                V v = com.imageanalysis.commons.util.java.Objects.requireNonNull((V) input[i + 1]);
                int idx = probe(k);
                if (idx >= 0) {
