package com.imageanalysis.commons.gcp.sdk;
...
import com.imageanalysis.commons.gcp.StorageScope;
...
import static com.imageanalysis.commons.util.FileUtil.getFileNameFromUrl;
...
public class GcpSdk implements CloudMetadata, CloudStorage {
    ...
    public File downloadInFile(String bucketName, String storagePath) {
        ...
        String fileName = getFileNameFromUrl(storagePath);
